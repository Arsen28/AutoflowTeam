  ...
  return (
    <div className="max-w-1248 mx-auto w-full h-full mt-[42px] lg:mt-[95px] lg:flex justify-between pt-[30px] lg:pt-72 rounded-12 border border-gray-120 ">
      <div className='lg:max-w-1/2 lg:w-1/2'>
        <div className='max-w-full pl-[30px] lg:pl-[50px] xl:pl-110 pr-[30px] lg:pr-[90px] xl:pr-132 lg:mt-61'>
      ...
      <div className='lg:w-1/2 flex items-end justify-end mt-[36px] lg:mt-0'>
        <div className='max-w-full w-[314px] lg:w-557 h-[279px] lg:h-488 rounded-tl-12 rounded-br-12 border border-gray-120 ' >
