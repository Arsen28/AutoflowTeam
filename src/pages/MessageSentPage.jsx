  ...
  return (
    <div className="px-22 mb-[172px] flex justify-between gap-12">
      <div className="">
        ...
        <p className="mt-4 mb-9 text-8xl font-medium leading-none -tracking-3.84">Message Sent</p>
        <p className='max-w-[486px] text-[#FFFFFF99] leading-24 -tracking-0.5'>
          Thank you for contacting Autoflow! Our support team has received your message and will reach out to you shortly. We appreciate your patience and look forward to assisting you.
        </p>
